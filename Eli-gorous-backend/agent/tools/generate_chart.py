...
def generate_chart(
    ...
    """
    Generates an interactive chart from query results.
    ...
    """
    try:
        # 1. Convert the raw dictionary back into a pandas DataFrame
        ...
        # (The LLM will do the deep thinking in the explain_data tool, but we need a basic string here)
